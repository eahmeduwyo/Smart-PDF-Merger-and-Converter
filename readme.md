...
I was faced with over **1,300 files**, a mix of PDFs, Word documents, and images, that needed to be grouped by student and merged into single documents for reserving for upcoming years. Doing this manually would have been an impossible, daunting task. I created this notebook to automate the entire workflow, saving countless hours of manual labor.
